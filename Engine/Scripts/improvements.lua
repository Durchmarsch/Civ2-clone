...
-- ===== Wonders (MGE indices). CivWide => effects apply to every city of the owner. =====
-- Effects below are only the ones expressible with the current Effects enum; many wonders
-- (Leonardo's Workshop, Darwin's Voyage, Marco Polo, Oracle, etc.) need bespoke mechanics.

--Pyramids (39): acts as a Granary in every city of the civilization.
civ.getImprovement(39).CivWide = true
civ.getImprovement(39).Effects.Add(civ.core.Effects.FoodStorage, 50)
